...
export class GeolocApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getMessage(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Geolocs/:id/Message";
    let _routeParams: any = {
  ...
  public linkOrganizations(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Geolocs/:id/Organizations/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * </em>
   */
  public getBeacon(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Geolocs/:id/Beacon";
    let _routeParams: any = {
  ...
  public countOrganizations(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Geolocs/:id/Organizations/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `result` – `{any}` - 
   */
  public createFromParsedPayload(message: Message, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Geolocs/from-payload";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
  ...
  /**
   * Statistical information for Geoloc registers.
   *
