...
/**
 * Api services for the `Beacon` model.
 */
@Injectable()
export class BeaconApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getBubbles(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Beacons/bubbles";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public getBubbleBydId(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Beacons/bubbles/:id";
    let _routeParams: any = {
  ...
  /**
   * Statistical information for Beacon registers.
   *
