 ...
 */
@Injectable()
export class AlertApi extends BaseLoopBackApi {
  ...
  public linkOrganizations(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Alerts/:id/Organizations/rel/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * </em>
   */
  public getConnector(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Alerts/:id/Connector";
    let _routeParams: any = {
  ...
  public triggerByData(data_parsed: any, device: any, req: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof data_parsed !== 'undefined' && data_parsed !== null) _urlParams.data_parsed = data_parsed;
   ...
   *  - `result` – `{any}` - 
   */
  public test(alertId: any, req: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Alerts/test";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof alertId !== 'undefined' && alertId !== null) _urlParams.alertId = alertId;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }

  /**
   * Statistical information for Alert registers.
   *
