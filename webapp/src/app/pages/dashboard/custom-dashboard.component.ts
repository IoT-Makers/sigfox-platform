...
import {RealTime, UserApi} from '../../shared/sdk/services/index';
import {Dashboard, Device, FireLoopRef, Geoloc, Message, User} from '../../shared/sdk/models/index';
...
export class CustomDashboardComponent implements OnInit, OnDestroy {
  ...
  private dashboardReady: boolean = false;
  ...
  addWidget():void{
    this.dashboard.widgets.push(this.newWidget);
    this.newWidget = {
      name: "",
      icon: "",
      description: "",
