 ...
 */
@Injectable()
export class AlertHistoryApi extends BaseLoopBackApi {
  ...
  public getOrganization(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/AlertHistories/:id/Organization";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Statistical information for AlertHistory registers.
   *
