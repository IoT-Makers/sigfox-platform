...
/***/ "../../../../../src/app/pages/devices/devices.component.scss":
...
var DevicesComponent = (function () {
    function DevicesComponent(rt, deviceApi) {
        var _this = this;
        this.rt = rt;
        this.deviceApi = deviceApi;
        this.device = new __WEBPACK_IMPORTED_MODULE_1__shared_sdk_models__["b" /* Device */]();
        this.deviceToEdit = new __WEBPACK_IMPORTED_MODULE_1__shared_sdk_models__["b" /* Device */]();
        ...
        this.rt.onReady().subscribe(function () {
            ...
            _this.deviceRef.on('change', { limit: 1000, order: 'updatedAt DESC', include: ['Parser', 'Category'] }).subscribe(function (devices) {
    ...
    DevicesComponent.prototype.update = function (device) {
        this.edit = false;
        this.deviceRef.upsert(device).subscribe();
    };
    DevicesComponent.prototype.cancel = function () {
        this.edit = false;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__devices_component__ = __webpack_require__("../../../../../src/app/pages/devices/devices.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__devices_routing_module__ = __webpack_require__("../../../../../src/app/pages/devices/devices-routing.module.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DevicesModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_6__devices_routing_module__["a" /* DevicesRoutingModule */],
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_5__devices_component__["a" /* DevicesComponent */]]
    })
], DevicesModule);
